  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" " target="">
        ...
        <span class="ms-1 font-weight-bold text-white"><b>NIX</b></span>
      </a>
    </div>
    ...
    <!-- <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main"> -->
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/clientes.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/suministros.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/cronograma.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-primary mt-4 w-100" href="../exit.php" type="button">Cerrar Sesion</a>
      </div>
    </div>
  </aside>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Insumos</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Suministros</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr></tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Fecha vencimiento</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Codigo item</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          ...
          <p>Configura la barra de navegación</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">Elige el estilo de la barra de navegación.</p>
        </div>
        <div class="d-flex">
